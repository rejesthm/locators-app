...
class AddAreaPageWidget extends StatefulWidget {
  const AddAreaPageWidget({super.key});

  @override
  State<AddAreaPageWidget> createState() => _AddAreaPageWidgetState();
}

class _AddAreaPageWidgetState extends State<AddAreaPageWidget> {
  late AddAreaPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAreaPageModel());
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'General notes about area',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Inter',
