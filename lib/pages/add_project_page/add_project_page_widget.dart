...
class AddProjectPageWidget extends StatefulWidget {
  const AddProjectPageWidget({super.key});

  @override
  State<AddProjectPageWidget> createState() => _AddProjectPageWidgetState();
}

class _AddProjectPageWidgetState extends State<AddProjectPageWidget> {
  late AddProjectPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProjectPageModel());

    _model.projectReferenceTextController ??= TextEditingController();
    _model.projectReferenceFocusNode ??= FocusNode();

    _model.projectTitleTextController ??= TextEditingController();
    _model.projectTitleFocusNode ??= FocusNode();

    _model.projectDescriptionTextController ??= TextEditingController();
                          ...
                          child: Container(
                            ...
                            child: Align(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.projectReferenceFocusNode,
                                autofocus: false,
                                obscureText: false,
                            ...
                            child: Align(
                              ...
                              child: TextFormField(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .projectTitleTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.projectDescriptionTextController,
                                    focusNode:
                                        _model.projectDescriptionFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.projectStatusValue == null) {
                              return;
                            }
                            ...
                            await ProjectsRecord.collection
                                ...
                                .set(createProjectsRecordData(
                                  projectDescription: _model
                                      .projectDescriptionTextController.text,
                                  projectStatus: _model.projectStatusValue,
                                  projectTask: true,
                                  projectValue: 0.0,
                                  projectTitle:
                                      _model.projectTitleTextController.text,
                                  projectReference: _model
                                      .projectReferenceTextController.text,
                                ));
