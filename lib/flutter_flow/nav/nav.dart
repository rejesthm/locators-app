...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/siteDetailsPage',
          asyncParams: {
            'siteDetails': getDoc(['sites'], SitesRecord.fromSnapshot),
          },
          builder: (context, params) => SiteDetailsPageWidget(
            siteDetails: params.getParam(
              'siteDetails',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'contact_details_page',
          path: '/contactDetailsPage',
          asyncParams: {
            'contactDetails': getDoc(['contacts'], ContactsRecord.fromSnapshot),
          },
          builder: (context, params) => ContactDetailsPageWidget(
            contactDetails: params.getParam(
              'contactDetails',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => ProjectDetailsPageWidget(
            projectDetails: params.getParam(
              'projectDetails',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          path: '/rackInspectionmodulePage',
          builder: (context, params) => RackInspectionmodulePageWidget(
            projectReference: params.getParam(
              'projectReference',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          asyncParams: {
            'taskDetails': getDoc(['tasks'], TasksRecord.fromSnapshot),
          },
